...
|---|---|---|---|
| `ICNEWSRADIO_01` | `Plugins/Qasset/Content/Audio/WAV/Radio/` | 1475.37 | émission complète, la seule piste de la station aujourd'hui |
| `I-C_News_YellowWall` | idem | 259.68 | module d'antenne sur YellowWall |
| `WAV_I-C_News_Radio_Var01` | idem | 259.68 | variante du même module |
| `WAV_I-C_News_Radio_Var02` | idem | 227.24 | seconde variante |
| `Pub_LifeLoop` | idem | 24.43 | spot LoopLife déjà enregistré, à garder en rotation |
